...
## 📋 구현 기능 목록
- [x] n번 동안 x대의 자동차가 전진하고 멈추는 기능
- [x] 각 자동차에 이름 부여하는 기능
- [x] 자동차가 쉼표 기준으로 구분하는 기능 / 구분된 이름의 개수를 셀 수 있는 기능 / (에) 자동차 이름이 쉼표를 기준으로 5자 이상이 되면 에러가 나게 하는 기능
- [x] 입력을 받는 기능
- [x] 0에서 9사이에서 무작위 값을 구하는 기능
- [x] 무작위 값이 4미만일 경우 전진하지 못하고, 4이상일 경우 전진하게 하는 기능
- [x] 경주 게임에서 등수를 알 수 있는 기능 → (조건 : 누가 우승을 했는지 알 수 있다 / 우승자는 1명 이상일 수 있음)
- [x] n명의 우승자에게 쉼표로 구분 할 수 있는 기능
